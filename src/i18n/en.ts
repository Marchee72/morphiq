...
export const en = {
  ...
  'body.about.visceralFat': 'An index for the fat around your organs. Estimated by a formula over your weight, height, age and sex — not measured directly.',
  ...
  'body.about.metabolicAge': 'Compares your metabolism against the average for each age. It is a formula estimate rather than a measurement — treat it as a reference, not a diagnosis.',
  'body.about.protein': 'An estimated body protein percentage, derived from muscle mass and water. Being a calculation on top of other calculations, watch the trend rather than the number.',
