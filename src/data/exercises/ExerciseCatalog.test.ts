...
const fixture: Exercise[] = [
  { id: '0025', name: 'barbell bench press', nameEs: 'press de banca con barra', category: 'chest', equipment: 'barbell', target: 'pectorals', muscleGroup: 'triceps', secondaryMuscles: ['triceps', 'shoulders'], instructionSteps: ['Lie down.', 'Press.'], instructionStepsEs: ['Acostate.', 'Empujá.'], image: 'images/0025-x.jpg', gifUrl: 'videos/0025-x.gif', attribution: '© Gym visual' },
  { id: '0043', name: 'barbell full squat', nameEs: 'sentadilla completa con barra', category: 'upper legs', equipment: 'barbell', target: 'glutes', muscleGroup: 'quadriceps', secondaryMuscles: ['hamstrings'], instructionSteps: ['Brace.', 'Squat.'], instructionStepsEs: ['Tensá el core.', 'Sentate.'], image: 'images/0043-x.jpg', gifUrl: 'videos/0043-x.gif', attribution: '© Gym visual' },
  { id: '0652', name: 'pull-up', nameEs: 'dominada', category: 'back', equipment: 'body weight', target: 'lats', muscleGroup: 'biceps', secondaryMuscles: ['forearms'], instructionSteps: ['Hang.', 'Pull.'], instructionStepsEs: ['Colgate.', 'Tirá.'], image: 'images/0652-x.jpg', gifUrl: 'videos/0652-x.gif', attribution: '© Gym visual' },
  { id: '0334', name: 'dumbbell lateral raise', nameEs: 'elevación lateral con mancuerna', category: 'shoulders', equipment: 'dumbbell', target: 'delts', muscleGroup: 'traps', secondaryMuscles: [], instructionSteps: ['Raise.'], instructionStepsEs: ['Elevá.'], image: 'images/0334-x.jpg', gifUrl: 'videos/0334-x.gif', attribution: '© Gym visual' },
  { id: '9001', name: 'incline barbell press', nameEs: 'press inclinado con barra', category: 'chest', equipment: 'barbell', target: 'pectorals', muscleGroup: 'triceps', secondaryMuscles: [], instructionSteps: ['Press.'], instructionStepsEs: ['Empujá.'], image: 'images/9001-x.jpg', gifUrl: 'videos/9001-x.gif', attribution: '© Gym visual' },
  { id: '9002', name: 'incline press', nameEs: 'press inclinado', category: 'chest', equipment: 'barbell', target: 'pectorals', muscleGroup: 'triceps', secondaryMuscles: [], instructionSteps: ['Press.'], instructionStepsEs: ['Empujá.'], image: 'images/9002-x.jpg', gifUrl: 'videos/9002-x.gif', attribution: '© Gym visual' },
];
