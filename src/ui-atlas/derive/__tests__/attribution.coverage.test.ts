...
const COMMON_LIFTS: [string, string][] = [
  ...
  ['Deadlift', 'hamstrings'], ['Romanian Deadlift', 'hamstrings'], ['Back Squat', 'quads'],
  ['Front Squat', 'quads'], ['Leg Press', 'quads'], ['Leg Curl', 'hamstrings'],
  ['Leg Extension', 'quads'], ['Calf Raise', 'glutes'], ['Bulgarian Split Squat', 'quads'],
  ['Hip Thrust', 'glutes'], ['Sentadilla', 'quads'], ['Peso muerto', 'hamstrings'],
  ['Curl femoral', 'hamstrings'], ['Glute Bridge', 'glutes'],
  ...
  ['Triceps Pushdown', 'triceps'], ['Skull Crusher', 'triceps'], ['Close-Grip Bench Press', 'triceps'],
  ['Press francés', 'triceps'], ['Wrist Curl', 'forearms'],
