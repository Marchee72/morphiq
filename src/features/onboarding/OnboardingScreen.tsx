...
export const OnboardingScreen: React.FC = () => {
  ...
  const go = async () => { if(!ok||!g)return; await createProfile({ name:n.trim(), gender:g, birthDate:new Date(b), height:hn }); };
    ...
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'100dvh',padding:16}}>
      ...
      <Card style={{maxWidth:420,width:'100%'}}>
        <div style={{display:'flex',flexDirection:'column',gap:14}}>
          ...
          <Button onClick={go} disabled={!ok}>Create profile</Button>
